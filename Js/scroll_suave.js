...
for( let f = 0; f < anc_menu.length; f++){
  anc_menu[f].addEventListener('click',(t)=>{
    ...
    var alt_inicio = document.querySelector('#inicio').getBoundingClientRect().top
    var alt_sobre_mim = document.querySelector('#sobre_mim').getBoundingClientRect().top
    var alt_habilidades = document.querySelector('#habilidades').getBoundingClientRect().top
    var alt_projetos =  document.querySelector('#projetos').getBoundingClientRect().top
